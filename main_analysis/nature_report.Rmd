...
s_3_r <- c('R^2', round(r2_nakagawa(log_mod_3)$R2_conditional, 3))
...
s_4_r_log <- c('R^2', round(PseudoR2(log_mod_4), 3))
...
s_5_r <- c('R^2', round(r2_nakagawa(log_mod_5)$R2_conditional, 3))
